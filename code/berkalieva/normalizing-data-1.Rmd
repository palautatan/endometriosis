...
norm_subset_genes <- norm[,5:106]
norm_subset <- norm_subset_genes %>% filter(severity == "Moderate/Severe" | severity == "Uterine Pelvic Pathology" | severity == "Minimal/Mild")

norm_sub <- norm_subset[,2:102]
